          ...
          <div className="space-y-4">
            {info.map((item, i) => (
              <motion.div
                ...
                whileHover={{ x: 4 }}
                className="bg-white rounded-2xl p-6 flex items-start gap-5 shadow-sm border border-gray-100 hover:border-amber-200 hover:shadow-md transition-all duration-200"
              >
