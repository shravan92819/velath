...
const info = [
  ...
  },
  {
    ...
    label: "Email",
    value: "prabha@velath.com",
    sub: "Business enquiries welcome",
    href: "mailto:prabha@velath.com",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative z-10">
                ...
                <div className="border-t border-white/10 pt-8 space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <a
                      href="tel:+9715526549"
                      className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 hover:bg-amber-400/10 border border-white/10 hover:border-amber-400/30 transition-all duration-200 text-sm text-gray-300 hover:text-amber-400"
                    >
